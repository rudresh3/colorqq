...
const page = () => {
  return (
    <div>
      <div className="w-[80vw] flex flex-col items-center justify-center mx-8 lg:mx-16">
        <div className="text-[3.5rem] font-bold py-8">
          <h1>Privacy Policy</h1>
        </div>
        <div className="">
          <h2 className="text-[1.5rem] font-medium">OVERVIEW</h2>
          <p>
            This website is operated by BHT Technologies. Throughout the site,
            the terms “we”, “us” and “our” refer to BHT Technologies. BHT
            Technologies offers this website, including all information, tools
          ...
          <div className="">
            <h2 className="text-[1.5rem] font-medium">ONLINE STORE TERMS</h2>
            <p>
            ...
            <div className="">
              <h2 className="text-[1.5rem] font-medium"> GENERAL CONDITIONS</h2>
              <p>
              ...
              <div className="">
                ...
                <p>
                  ...
                  complete or more timely sources of information. Anpy reliance
                ...
                <div className="">
                  ...
                  <div className="">
                    ...
                    <p>
                      ...
                      possible the colors and images of our products. We cannot
                      guarantee that your computer monitor's display of any
                      color will be accurate. We reserve the right, but are not
                      obligated, to limit the sales of our products or Services
                      to any person, geographic region or jurisdiction. We may
